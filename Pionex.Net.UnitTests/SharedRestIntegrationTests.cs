...
namespace Pionex.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IPionexRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddPionex(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IPionexRestClient>().SpotApi.SharedClient;
        }
